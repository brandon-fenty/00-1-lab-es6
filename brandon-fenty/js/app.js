...
function displayPics(){
  ...
  // The reason that the line of code throws an error is because let is only scoped to the block of code it is declared in. Since the console log is outside of the block of code, it see's rando as an undefined variable.
  console.log(viewed);
